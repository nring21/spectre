...
build_connectivity_by_hexahedron(const std::vector<double>& sorted_x,
  ...
  //         gsl::at(point_one,1) = sorted_y[j];
  //         gsl::at(point_two,1) = sorted_y[j];
  //         gsl::at(point_three,1) = sorted_y[j + 1];
  //         gsl::at(point_four,1) = sorted_y[j + 1];
  ...
  //       point_one[0] = sorted_x[i];
  //       point_two[0] = sorted_x[i + 1];
  //       gsl::at(point_three,0) = sorted_x[i + 1];
  //       gsl::at(point_four,0) = sorted_x[i];
  ...
  //           gsl::at(point_three,2) = sorted_z[k];
  //           gsl::at(point_four,2) = sorted_z[k];
