...
class SphKerrSchild : public AnalyticSolution<3_st>,
 ...
 public:
  ...
  struct internal_tags {
    ...
    template <typename DataType, typename Frame = ::Frame::Inertial>
    using deriv_jacobian = ::Tags::TempijK<10, 3, Frame, DataType>;
    template <typename DataType, typename Frame = ::Frame::Inertial>
    ...
    template <typename DataType, typename Frame = ::Frame::Inertial>
    using inv_jacobian = ::Tags::TempIj<16, 3, Frame, DataType>;
    template <typename DataType, typename Frame = ::Frame::Inertial>
    using matrix_E1 = ::Tags::TempIj<17, 3, Frame, DataType>;
    template <typename DataType, typename Frame = ::Frame::Inertial>
    using matrix_E2 = ::Tags::TempIj<18, 3, Frame, DataType>;
    template <typename DataType, typename Frame = ::Frame::Inertial>
    using deriv_inv_jacobian = ::Tags::TempijK<19, 3, Frame, DataType>;
    template <typename DataType, typename Frame = ::Frame::Inertial>
    using x_kerr_schild = ::Tags::TempI<20, 3, Frame, DataType>;
    template <typename DataType, typename Frame = ::Frame::Inertial>
  ...
  class IntermediateComputer {
   public:
    ...
    void operator()(
        gsl::not_null<tnsr::I<DataType, 3, Frame>*> G1_dot_x,
        gsl::not_null<CachedBuffer*> cache,
        internal_tags::G1_dot_x<DataType, Frame> /*meta*/) const noexcept;

    void operator()(
        gsl::not_null<tnsr::i<DataType, 3, Frame>*> G2_dot_x,
        gsl::not_null<CachedBuffer*> cache,
    ...
    void operator()(
        gsl::not_null<tnsr::Ij<DataType, 3, Frame>*> matrix_E1,
        gsl::not_null<CachedBuffer*> cache,
        internal_tags::matrix_E1<DataType, Frame> /*meta*/) const noexcept;

    void operator()(
        gsl::not_null<tnsr::Ij<DataType, 3, Frame>*> matrix_E2,
        gsl::not_null<CachedBuffer*> cache,
    ...
    void operator()(
        gsl::not_null<tnsr::I<DataType, 4, Frame>*> deriv_H,
        gsl::not_null<CachedBuffer*> cache,
        internal_tags::deriv_H<DataType, Frame> /*meta*/) const noexcept;

    void operator()(
        gsl::not_null<tnsr::Ij<DataType, 4, Frame>*> deriv_l,
        gsl::not_null<CachedBuffer*> cache,
